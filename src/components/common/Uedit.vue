...
const props = defineProps({
  ...
  plugins: {
    type: [String, Array],
    default: 'codesample link image table lists fullscreen'
  },
  toolbar: {
    type: [String, Array],
    default: 'bold italic underline h1 h2 blockquote codesample numlist' +
      'bullist link image removeformat fullscreen'
  },
  height: {
    type: Number,
    defult: 300
